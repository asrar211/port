...
import Image1 from '../public/assets/images/abc.png';
        ...
        <div className='w-full flex flex-col items-center justify-center gap-28 pt-20'>
          ...
          <div className='flex flex-col xl:flex-row-reverse gap-6'>
              <a className='w-full xl:w-1/2 h-auto relative group' href="">
                <div>
                  <Image className='w-full h-full object-contain' src={Image1} alt='image'/>
                </div>
              </a>
              ...
              <div className='text-2xl flex gap-4'>
                <a className='hover:text-textGreen duration:300'  href="www.github.com/asrar211">
                  <TbBrandGithub />
                </a>
