  ...
  return (
    <div className='w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4'>
            ...
            <div className='hidden mdl:inline-flex items-center gap-10'>
             ...
             </div>
             {
                showMenu && (
                    ...
                    initial={{ x: 20, opacity:0}}
                    animate={{ x: 0, opacity: 1}}
                    transition={{duration: 0.2, delay: 0.3, easew: "easeIn",}}
                    >Projects
                    </motion.li>
                    </Link>
                    <Link href="#contact" onClick={handleScroll} className='flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link'>
                ...
                href="https://www.github.com/asrar211" target="_blank">
        ...
        transition={{duration: 0.2, delay: 1.1, ease: "easeIn",}}
         href="https://www.linkedin.com/in/mohammad-asrar-bhat-4a897b18b" target="_blank">
          <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
        ...
        initial={{ y: 20, opacity:0}}
        animate={{ y: 0, opacity: 1}}
        transition={{duration: 0.2, delay: 1.2, ease: "easeIn",}}
         href="https://www.instagram.com/_asrar_ali" target="_blank">
          <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
        ...
        initial={{ y: 20, opacity:0}}
        animate={{ y: 0, opacity: 1}}
        transition={{duration: 0.2, delay: 1.3, ease: "easeIn",}}
        href="https://www.facebook.com/aliasrar2" target="_blank">
          <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
        ...
        href="mailto:aliasrar84@gmai.com">
         <p>asrar@react.me</p>
        </motion.a>
        </motion.div>
                </div>
